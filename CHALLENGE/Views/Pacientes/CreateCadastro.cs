...
using CHALLENGE.Models; // Certifique-se de que o namespace está correto para o seu modelo de Paciente
using CHALLENGE.Data; // Adapte para o seu contexto de dados, se necessário
